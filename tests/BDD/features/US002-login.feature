Feature: US002 - Login na plataforma
    ...
    Scenario Outline: CT04 - Tentar realizar login com email e senha inválidos
        ...
        Examples:
            | e-mail    | senha        | mensagem                                                                                                                                    |
            | user1_eba | psw!ebac@tes | Erro: O usuário user1_ebac não está registrado neste site. Se você não está certo de seu nome de usuário, experimente o endereço de e-mail. |